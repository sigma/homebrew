...
class Weechat < Formula
  ...
  def install
    ...
    inreplace 'src/plugins/python/CMakeLists.txt',
      '${PYTHON_LIBRARY}', '/usr/local/Cellar/python/2.7.3/Frameworks/Python.framework/Versions/2.7/lib/python2.7/config/libpython2.7.dylib'
    inreplace 'src/plugins/python/CMakeLists.txt',
      '${PYTHON_INCLUDE_PATH}', '/usr/local/Cellar/python/2.7.3/Frameworks/Python.framework/Versions/2.7/include/python2.7'
